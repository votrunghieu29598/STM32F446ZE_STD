...
//		return 0;
//	}
//	I2C_Check_Connected(I2C1, SSD1306_I2C_ADDR, "SSD1306");
	/* A little delay */
	uint32_t p = 2500;
	while(p>0)
		p--;
//	I2C1_DMA(SSD1306_I2C_ADDR,1,&Bufferssd1306[0]);
	/* Init LCD */
...
void ssd1306_I2C_Init(void) {
	...
	while(p>0)
		p--;
	I2C_Initstruct(SSD1306_I2C, SSD1306_I2C_PIN, I2C_CLOCK_FAST_MODE);
...
void ssd1306_I2C_WriteMulti(uint8_t address, uint8_t reg, uint8_t* data, uint16_t count) {
	...
	I2C1_DMA(SSD1306_I2C_ADDR,count + 1,Bufferssd1306);
}

void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	Bufferssd1306[0] = reg;
	Bufferssd1306[1] = data;
	I2C1_DMA(SSD1306_I2C_ADDR,3,Bufferssd1306);
}
