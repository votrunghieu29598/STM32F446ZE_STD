...
uint8_t SSD1306_Init(void) {
	...
	I2C_Check_Connected(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x78, "SSD1306");
...
void ssd1306_I2C_Init(void) {
	...
	while(p>0)
		p--;
	I2C_Initstruct(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x89, 400000);
...
dt[i+1] = data[i];
	...
	I2C_Write_MutiData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), address, reg, count+1 ,dt );
}
...
void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	...
	I2C_Write_MutiData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), address, reg, 2, dt);
}
